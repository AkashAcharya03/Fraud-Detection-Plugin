...
class Plugin:
    ...
    def access(self, kong_instance):
        ...
        headers = kong_instance.request.get_headers()
        ...
        if agent_response.get("fraud_detected", False):
            ...
            kong_instance.log.info("No fraud detected, forwarding request to upstream.")
            return
